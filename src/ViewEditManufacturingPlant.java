...
public class ViewEditManufacturingPlant {
	
	WebDriver ldriver;

	public ViewEditManufacturingPlant(WebDriver rdriver){
	...
	@FindBy(xpath = "//clr-icon[@shape='close']") 	//Close View
	@CacheLookup
	WebElement closeview;
	
	@FindBy(xpath = "//clr-icon[@shape='pencil']") //Edit Manufacturing Plant
	@CacheLookup
